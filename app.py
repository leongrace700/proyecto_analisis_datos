    ...
    if st.session_state.df_clean is None:
        ...
        with c_chart1:
            if 'tasa_efectiva_promedio' in df_curr.columns and 'nombre_entidad' in df_curr.columns:
                ...
                st.plotly_chart(fig_rank, use_container_width=True, key="chart_rank_tab2")
        ...
        with c_chart2:
            if 'tipo_credito' in df_curr.columns and 'monto_desembolsado' in df_curr.columns:
                ...
                st.plotly_chart(fig_pie, use_container_width=True, key="chart_pie_tab2")
...
with tab_simulador:
    ...
    if st.session_state.df_clean is None:
        ...
        if df_tasas.empty or 'tasa_efectiva_promedio' not in df_tasas.columns:
            ...
            st.plotly_chart(fig_bar, use_container_width=True, key="chart_bar_tab3")
